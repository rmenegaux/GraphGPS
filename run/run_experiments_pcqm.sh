...
DATASET="pcqm4m"
run_repeats ${DATASET} "GraphiTmedium+RWSE.lr0002.dropout0.1" "name_tag GraphiTmedium+RWSE.lr0002.dropout0.1"
run_repeats ${DATASET} "GraphiTmedium+RWSE.lr0005.dropout0.5" "name_tag GraphiTmedium+RWSE.lr0005.dropout0.5"
run_repeats ${DATASET} "GraphiTmedium+RWSE.lr0002.dropout0.5" "name_tag GraphiTmedium+RWSE.lr0002.dropout0.5"
run_repeats ${DATASET} "GraphiTmedium+RWSE-Rings.lr0002.dropout0.1" "name_tag GraphiTmedium+RWSE-Rings.lr0002.dropout0.1"
#run_repeats ${DATASET} "GraphiT+RWSE-Rings" "name_tag GraphiT+RWSE-Rings"
#run_repeats ${DATASET} "GraphiT+RWSE" "name_tag GraphiT+RWSE"
