...
cfg_suffix="GraphiT+RWSE_AdjMask_noCoalesce" #"GPS+RWSE+Rings-GraphiT_EJ_tests" # "GraphiT_EJ_tests"
name="'QK+E_multi*V+E_multi_DptConn_AdjMask_noCoalesce_4seeds'"
#addition="'addition'"
